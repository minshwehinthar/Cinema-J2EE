...
if("POST".equalsIgnoreCase(request.getMethod())){
    ...
    if(pageOrders.isEmpty()){
        out.print("<tr><td colspan='7' class='px-6 py-8 text-center'><div class='w-16 h-16 mx-auto mb-4 text-gray-300'><svg fill='none' stroke='currentColor' viewBox='0 0 24 24'><path stroke-linecap='round' stroke-linejoin='round' stroke-width='1' d='M9 5H7a2 2 0 00-2 2v12a2 2 0 002 2h10a2 2 0 002-2V7a2 2 0 00-2-2h-2M9 5a2 2 0 002 2h2a2 2 0 002-2M9 5a2 2 0 012-2h2a2 2 0 012 2m-3 7h3m-3 4h3m-6-4h.01M9 16h.01'/></svg></div><h3 class='text-lg font-medium text-gray-600 mb-2'>No pending orders found</h3><p class='text-gray-500'>All orders have been processed or try adjusting your search.</p></td></tr>");
    } else {
        for(Order o : pageOrders){
            User user = userDAO.getUserById(o.getUserId());
            Theater theater = theaterDAO.getTheaterById(o.getTheaterId());
%>
<tr class="hover:bg-red-50 transition-colors duration-150" id="orderRow_<%=o.getId()%>">
    <td class="px-6 py-4">
        ...
        <div class="p-8 max-w-8xl mx-auto">
            ...
            <div class="flex justify-between items-center mb-6">
				...
				<nav class="text-gray-500 text-sm mb-6" aria-label="Breadcrumb">
					<ol class="list-none p-0 inline-flex">
						...
						<li class="flex items-center text-gray-900 font-semibold">Pending Orders</li>
					</ol>
				</nav>
                    <h1 class="text-2xl font-bold text-gray-900">Pending Orders</h1>
                    <p class="text-gray-600 mt-1">Manage and process pending food orders</p>
                </div>
            </div>
            ...
            <div class="flex justify-between items-center mb-6">
                ...
                <div class="text-sm text-gray-600">
                    <span class="font-medium"><%= allPendingOrders.size() %></span> pending orders
                </div>
            </div>
                    ...
                    <table class="min-w-full text-sm text-left">
                        <thead class="bg-red-50 text-gray-900 uppercase text-xs">
                            <tr>
                                ...
                                <th class="px-6 py-4 font-semibold cursor-pointer" onclick="sortTable('customer')">
                                    <div class="flex items-center space-x-1">
                                        <span>Customer</span>
                                        <svg class="w-4 h-4 text-gray-600" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M7 16V4m0 0L3 8m4-4l4 4m6 0v12m0 0l4-4m-4 4l-4-4"/>
