...
if(msg === 'updated') showToast('Profile updated successfully!', 'bg-green-500');
else if(msg === 'image_updated') showToast('Profile image updated successfully!', 'bg-green-500');
else if(msg === 'password_updated') showToast('Password updated successfully!', 'bg-green-500');
else if(msg === 'error') showToast('An error occurred. Please try again.');
else if(msg === 'invalid_password') showToast('Current password is incorrect.');
</script>
